...
def collate_fn_inference(batch, device):
    ...
    return (mixture, instrument, function), dynamics, song_dir
...
if __name__ == '__main__':
    ...
    for idx, (mixture, instrument, function, tracks, aux_feature, mask) in tqdm(enumerate(val_loader), total=len(val_loader)):
        print(mixture.shape)
