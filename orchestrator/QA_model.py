...
if __name__ == '__main__':
    ...
    from QA_dataset import Slakh2100_Pop909_Dataset, collate_fn
    ...
    model.load_state_dict(torch.load('./new_qa.pt', map_location=torch.device('cpu')), strict=True)
    model.to(DEVICE)

    slakh_dir = "data_file_dir/Slakh2100_inference_set"
    pop909_dir = None
