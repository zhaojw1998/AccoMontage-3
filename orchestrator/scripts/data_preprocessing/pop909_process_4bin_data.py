...
pop909_4bin_dir = '../Q&A/POP909-Dataset/quantization/POP09-PIANOROLL-4-bin-quantization/'
pop909_midi_dir = '../Q&A/POP909-Dataset/POP909/'
meta_info = pd.read_excel(os.path.join(pop909_midi_dir, 'index.xlsx'))
save_root = '../Q&A/POP909-Dataset/quantization/4_bin_midi_quantization_with_dynamics_and_chord/'
